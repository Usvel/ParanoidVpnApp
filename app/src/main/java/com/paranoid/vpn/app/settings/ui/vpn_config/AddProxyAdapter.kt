...
class AddProxyAdapter(private val dataSet: Array<String>) :
    RecyclerView.Adapter<AddProxyAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.add_string_item_view, viewGroup, false)
