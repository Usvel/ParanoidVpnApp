...
import com.example.paranoid.ui.vpn.basic_client.protocol.tcpip.Packet.IP4Header;
...
class BioTcpHandlerOld implements Runnable {
    ...
    public BioTcpHandlerOld(BlockingQueue<Packet> queue, BlockingQueue<ByteBuffer> networkToDeviceQueue, VpnService vpnService) {
        this.queue = queue;
